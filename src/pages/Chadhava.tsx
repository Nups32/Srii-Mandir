...
export default function Chadhava() {
  ...
  return (
    <section className="">
      <div className="bg-linear-to-br from-[#fae1c8] to-white py-16">
        <div className="max-w-7xl mx-auto px-4 lg:flex lg:items-center lg:gap-16">
          ...
          <div className="lg:w-1/2">
            <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-8! leading-relaxed">
              Offer Chadhava as per Vedic rituals at sacred Hindu Pilgrimages
              and Temples in India through Srii Mandir from anywhere in the world!
            </h1>
            ...
            <ul className="space-y-4 mb-8!">
              {features.map((feature, idx) => (
                <li key={idx} className="flex items-start gap-3 text-gray-700">
                  <CircleCheck className="w-5 h-5 mt-1 text-orange-500 shrink-0" />
                  <span>{feature}</span>
                </li>
              ))}
            </ul>
            ...
            <div className="flex flex-wrap gap-4">
              <button
                ...
                className="bg-green-700 text-white! font-semibold px-6 py-3 rounded-lg hover:bg-green-800 transition-colors cursor-pointer"
              >
                View Now
              </button>
              ...
              <button
                ...
                className="border border-gray-300 text-gray-800! font-semibold px-6 py-3 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer"
              >
                How It works?
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 mt-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4!">
            Upcoming Chadhava Offerings on Srii Mandir.
          </h2>
          <p className="text-gray-700 font-semibold text-lg">
            Experience the divine with Srii Mandir Chadhava Seva. Offer Chadhava at
            renowned temples across India, receiving blessings and a video
            recording of the ceremony performed by our Purohit ji on your
            behalf.
          </p>
        </div>
      </div>
      ...
      <section className="max-w-7xl mx-auto px-4 pt-16">
        <h2 className="text-3xl font-bold text-gray-900 mb-10!">
          Start your Sacred Journey with Srii Mandir Chadhava Service
        </h2>
        <p className="text-xl mb-8!">
          Why make offerings through Srii Mandir Chadhava Seva?
        </p>
      ...
      {/* how chadhava works */}
      <section ref={howItWorksRef} className="max-w-7xl mx-auto px-4 py-8">
        <h2 className="text-4xl font-bold text-gray-900 my-10!">
          How does Srii Mandir Online Chadhava Works?
        </h2>
