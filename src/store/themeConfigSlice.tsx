...
const themeConfigSlice = createSlice({
    ...
    reducers: {
        ...
        setPageTitle(_state, { payload }) {
            document.title = `${payload} | Strategise`;
        },
    },
});

export const { sidebarCollapse, toggleTheme, toggleMenu, toggleLayout, toggleRTL, toggleAnimation, toggleNavbar, toggleSemidark, toggleLocale, setPageTitle, toggleSidebar } = themeConfigSlice.actions;
