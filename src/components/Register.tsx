        ...
        {isOTPVerification && (
          <div>
            <div className="text-2xl font-semibold text-white">
              <h3 className="flex justify-center items-center text-md my-2">
                Verify OTP
              </h3>
            </div>
            ...
            >
                ...
                {inputOtp.map((data, index) => {
                  return (
                    <input
                      ...
                      className="w-14 h-14 flex flex-row text-center text-3xl font-bold text-white bg-transparent border-b-2 border-gray-300 focus:outline-none focus:border-blue-800 hover:border-blue-800 transition-colors"
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full outline-2 text-white font-semibold rounded-2xl my-6 px-4 py-2 hover:bg-[#34fac5] transition duration-300 cursor-pointer"
              >
                {isLoading ? (
                  <>
